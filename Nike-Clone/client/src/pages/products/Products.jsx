...
export const Products = () => {
    ...
    const handleSingleProduct = (data) => {
        ...
        navigate(`/description/a`); // Assuming you have a route like '/description/:productId'
                        ...
                        >
                            {products.map((product, index) => (
                                ...
                                <ProductDisplayBox
                                    ...
                                    // key={product[index]._id} // Use _id as the key
                                    // onClick={() => { handleSingleProduct(product[index]._id) }} // Pass product._id here
